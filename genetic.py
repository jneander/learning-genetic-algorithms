...
def get_best(
    get_fitness, targetLen, optimalFitness, geneSet, display, custom_mutate=None,
    custom_create=None, maxAge=0, poolSize=1, crossover=None
):
    random.seed()
    ...
    strategyLookup = {
        ...
        Strategies.Mutate: lambda p, i, o: fnMutate(),
    ...
    for improvement in _get_improvement(fnMutate, fnGenerateParent, maxAge, poolSize):
        display(improvement)
